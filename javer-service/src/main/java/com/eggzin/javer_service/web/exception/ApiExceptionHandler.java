...
public class ApiExceptionHandler {
	...
	public ResponseEntity<ErrorMessage> argumentosInvalidosException(ArgumentosInvalidosException ex,
																		HttpServletRequest request,
																		BindingResult result){
		log.error("CLIENTE-SERVICE Error - ", ex);
		return ResponseEntity
	...
	public ResponseEntity<Void> forbiddenException(RuntimeException ex,
																 HttpServletRequest request){
		log.error("CLIENTE-SERVICE Error - ", ex);
		return ResponseEntity
